...
async function main() {
    ...
    console.log("✅ Tags created:", tags.map((tag) => tag.name));
    const adminUser = await prisma.user.upsert({
        ...
        create: {
            ...
            name: "Admin User",
            password: "$2b$10$K7L1OJ45/4Y2nIvhRVpCe.FSmhDdWoXehVzJptJ/op0lSsvqNu/1m",
            role: "ADMIN",
            profile: {
                create: {
    ...
    const posts = await Promise.all([
        ...
        prisma.post.create({
            data: {
                ...
                content: "Prisma is a modern database toolkit that makes database access easy and type-safe.",
                published: true,
    ...
    console.log("✅ Posts created:", posts.map((post) => post.title));
