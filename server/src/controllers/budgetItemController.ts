...
export const budgetItemController = {
  async getByBudgetId(req: Request, res: Response) {
    try {
      ...
      const budgetItems = await budgetItemService.getByBudgetIdAndUserId(
        budgetId || "",
        userId
      );
  ...
  async getById(req: Request, res: Response) {
    try {
      ...
      const budgetItem = await budgetItemService.getByIdAndUserId(
        id || "",
        userId
      );
      if (!budgetItem) {
  ...
  async update(req: Request, res: Response) {
    try {
      ...
      const budgetItem = await budgetItemService.updateByIdAndUserId(
        id || "",
        userId,
        {
          budgetedAmount: Number(budgetedAmount),
  ...
  async delete(req: Request, res: Response) {
    try {
      ...
      const deleted = await budgetItemService.deleteByIdAndUserId(
        id || "",
        userId
      );
      if (!deleted) {
